		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<!-- 检索 -->
						<form action="indexQuestionnaireCombination/list.do?QUESTIONNAIRE_ID=${pd.QUESTIONNAIRE_ID }" method="post" name="fatForm" id="fatForm">
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
                                     <a class="btn btn-sm btn-success" onclick="makeAll('批量新增');" title="批量新增">新增组合</a>
								</td>
								<td style="vertical-align:top;">
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '批量新增'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>indexQuestionnaireCombination/save.do?QUESTIONNAIRE_ID=${pd.QUESTIONNAIRE_ID}&tm='+new Date().getTime(),
						    	data: {IDS:str},
								dataType:'json',
