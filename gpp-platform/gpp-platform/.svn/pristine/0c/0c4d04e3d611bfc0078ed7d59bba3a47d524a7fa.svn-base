		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="knowledgeBase/saveObject.do" name="userForm" id="userForm" method="post" enctype="multipart/form-data">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td>
										<input type="hidden" name="diseases_code" id="diseases_code" value="" />
										<input type="text" name="diseases_name" id="diseases_name" value="" style="width: 280px" readonly="readonly"/>
										<a class="btn btn-mini btn-purple" onclick="chooseDisease();">疾病菜单</a>
									</td>
								</tr>
								<tr>
									<td style="width:150px;text-align: right;padding-top: 13px;">是否推荐：</td>
									<td>
										<label><input name="is_recommend" type="radio" value="1"  checked="checked"/>推荐</label>
										<label><input name="is_recommend" type="radio" value="0" />不推荐</label>
									</td>
								</tr>
								<tr>
									<td style="width:150px;text-align: right;padding-top: 13px;">首字母：</td>
									<td><input type="text" name="FIRST" id="FIRST" value="" maxlength="1"  style="width: 350px" onblur="YZSZM();"></td>
								</tr>
								<tr>
									<td style="width:150px;text-align: right;padding-top: 13px;">内容：</td>
									<td><textarea type="text" name="REMARK" id="remark" value=""  style="width: 350px"> </textarea></td>
								</tr>					
								<tr>
...
<script type="text/javascript">
	...
	$(function(){
		...
		$.post(url,{},
			...
			var htmlDepart = '<option value="">请选择</option>';
			...
			var htmlDiseases = '<option value="">请选择</option>';
	...
	function chooseDisease(){
		 ...
		 diag.Drag = true;
		 diag.Title = "疾病信息";
		 diag.URL = '<%=basePath%>knowledgeBase/getDiseaseData.do';
		 diag.Width = 1000;
		 diag.Height = 800;
		 ...
		 diag.OKEvent = function(){
	         	var id = diag.innerFrame.contentWindow.document.getElementById('_id').value;
	         	var name=diag.innerFrame.contentWindow.document.getElementById('_name').value;
	         	if(id !=''){
		         	$("#diseases_code").val(id);
		         	$("#diseases_name").val(name);
	         	}
	         	diag.close();
	      };
		 diag.show();
