		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="shape/${msg }.do" name="Form" id="Form" method="post" class="form-horizontal" autocomplete="off">
							<input type="hidden" name="ID" id="ID" value="${pd.ID }"/>
							<div id="zhongxin" style="padding-top: 13px;">
							<div class="form-group">
                            <div class="widget-box col-xs-12">
			                     <div class="widget-header">
			                           <h5 class="widget-title">体型记录表</h5>
	                              ...
	                              <div class="widget-body col-xs-12">
	                              	<div class="form-group">
                                           ...
                                           <div class="col-xs-12 col-sm-6">
                                               ...
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input onchange="changeBIM()" type="number" name="HEIGHT" id="HEIGHT"  value="${pd.HEIGHT }" placeholder="请输入身高"  title="身高" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
                                  	...
                                  	<div class="form-group">
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="WEIGHT">体重(kg):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input onchange="changeBIM()" type="number" step="1" name="WEIGHT" id="WEIGHT" value="${pd.WEIGHT }" placeholder="请输入体重" title="体重" style="width:98%;"/>
                                                   </span>
                                               </div>
                                           </div>
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="WAIST">腰围(cm):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input onchange="changeWHR()" type="number" step="1" name="WAIST" id="WAIST"  value="${pd.WAIST }" placeholder="请输入腰围"  title="腰围" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
                                  	<div class="form-group">
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="HIPLINE">臀围(cm):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input  onchange="changeWHR()" type="number" step="1" name="HIPLINE" id="HIPLINE" value="${pd.HIPLINE }" placeholder="请输入臀围" title="臀围" style="width:98%;"/>
                                                   </span>
                                               </div>
                                           </div>
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="BMI">BMI(体质特征):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input readonly="readonly" type="number" step="0.01" name="BMI" id="BMI"  value="${pd.BMI }" placeholder="体质特征"  title="体质特征" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
                                  	...
                                  	<div class="form-group">
                                                <div class="col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-8" id="COMMUNITYDiv">
                                                        <span   class="col-sm-12 from-control-span">
                                                        	<input type="text" readonly="readonly" class="span10 date-picker"  name="TEST_TIME" id="TEST_TIME" value="<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"  value="${pd.TEST_TIME }"/>" placeholder="测试时间" title="测试时间"  style="width:98%;" />
                                                        </span>
                                                    </div>
                                                </div>
												<div class="col-xs-12 col-sm-6">
                                                    ...
                                                    <div class="col-sm-8" id="AREADiv">
                                                        <span   class="col-sm-12 from-control-span">
                                                        	<input readonly="readonly" type="text" name="CREAT_TIME" id="CREAT_TIME" value="<fmt:formatDate pattern="yyyy-MM-dd HH:mm:ss"  value="${pd.CREAT_TIME }"/>" placeholder="生成时间" title="生成时间"  style="width:98%;" />
                                                        </span>
                                                    </div>
                                                </div>
							  		 </div>
							  		 <div class="form-group">
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="WHR">腰臀比(%):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input readonly="readonly" type="number" step="0.01" name="WHR" id="WHR"  value="${pd.WHR }" placeholder="腰臀比"  title="腰臀比" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
...
<script type="text/javascript">
	...
	function changeWHR() {
		...
		var HIPLINE = $("#HIPLINE").val();
		
		var bmi = WAIST/HIPLINE;
		bmi = bmi.toFixed(4);
		//alert(HIPLINE);
		$("#WHR").val(bmi*100);
	}
