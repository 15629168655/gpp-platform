...
<body class="no-skin">
			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="lcxm/sfxmlist.do" method="post" name="Form" id="Form">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center' style="width: 30px;">
												<label><input type='checkbox' name='ids' value="${var.ID }" id="${ID }" class="ace"/><span class="lbl"></span></label>
											</td>
						...
						<table style="width:100%;">
							<tr>
								<td class="center" colspan="12">
									<a class="btn btn-mini btn-primary" onclick="makeAll('${pd.BM}');">确定</a>
	...
	<script type="text/javascript">
		...
		function makeAll(msg){
			...
			$.ajax({
				type: "POST",
				url: '<%=basePath%>lcxm/goAddAll.do',
		    	data: {ids:str,msg:msg},
				dataType:'json',
				//beforeSend: validateData,
				cache: false,
				success: function(data){
					if(data.SFXMName != null && data.SFXMName != ""){
						alert("您所选中的收费项目："+data.SFXMName+"在此临床项目中已存在，请核实！");
					}
					top.Dialog.close();
					top.siMenu('z71','lm70','临床项目','lcxm/listAll.do?LCXM='+data.BM);
					//window.location.href = "lcxm/listAll.do?BM="+data.BM;
				}
			});
		}
