		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
					<!-- 健康资讯 发布页面 -->
					<form action="healthinformation/edit.do" name="Form" id="Form" method="post" enctype="multipart/form-data" >
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input type="file" name="FILE" id="FILE" value="" maxlength="255"  style="width:98%;"/>
									<c:if test="${not empty pd.IMAGE_ID }">
										<a href="javascript:download('${pd.IMAGE_ID}');" > 下载文件查看</a>
									</c:if>
									<c:if test="${ empty pd.IMAGE_ID}">
										<font>(暂无附件...)</font>
									</c:if>
								</td>
							...
							<tr>
									...
									<td style="padding-top: 3px;" >
										 <script id="editor"  name="REMARK"  type="text/plain" style="width:643px;height:159px;">${pd.REMARK}</script>
									</td>
								</tr>					
							<tr>
							...
							<tr>
									...
									<td><input type="text" name="FBR" readonly="readonly" id="FBR" value="${pd.FBR}" maxlength="50" placeholder="发布人" title="发布人" style="width:98%;"/></td>
							</tr>
							<tr>
