		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					...
					<form action="myuser/${msg }.do" name="Form" id="Form" method="post">
						<input type="hidden" name="MYUSER_ID" id="MYUSER_ID" value="${pd.MYUSER_ID}"/>
						...
						<table id="table_report" class="table table-striped table-bordered table-hover">
							...
							<tr>
								...
								<td><input class="span10 date-picker" name="BIRTHDAY" id="BIRTHDAY" value="${pd.BIRTHDAY}" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="生日" title="生日" style="width:98%;"/></td>
							</tr>
							<tr>
