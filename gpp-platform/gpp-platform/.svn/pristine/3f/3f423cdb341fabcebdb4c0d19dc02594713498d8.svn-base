package com.tbyf.controller.system.dictionaries;
...
public class DictionariesController extends BaseController {
	...
	public Map<String,String> queryDictionary(String bianma) throws Exception {
		return  dictionariesService.queryDictionary(bianma);
	}
