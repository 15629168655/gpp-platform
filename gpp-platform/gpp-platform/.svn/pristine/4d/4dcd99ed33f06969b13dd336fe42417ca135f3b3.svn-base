...
//			top.jzts();
		...
		$(function() {
			...
			//实现单选效果
			$("#simple-table").find(".ace").click(function(){
		...
		function save() {
            ...
            for(var i=0;i < document.getElementsByName('ids').length;i++){
                if(document.getElementsByName('ids')[i].checked){
                    parent[1].window.document.getElementById("DISEASE_CODE").value = $('#simple-table > tbody > tr')[i].children[2].innerText;
                    parent[1].window.document.getElementById("DISEASE_NAME").value = $('#simple-table > tbody > tr')[i].children[3].innerText;
                    top.Dialog.close();
                }
            }
		}
