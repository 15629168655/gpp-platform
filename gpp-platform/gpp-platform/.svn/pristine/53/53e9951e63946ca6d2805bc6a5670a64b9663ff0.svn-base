		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="pressure/${msg }.do" name="Form" id="Form" method="post" class="form-horizontal" autocomplete="off">
							<input type="hidden" name="ID" id="ID" value="${pd.ID }"/>
							<div id="zhongxin" style="padding-top: 13px;">
							<div class="form-group">
                            <div class="widget-box col-xs-12">
			                     <div class="widget-header">
			                           <h5 class="widget-title">血压记录</h5>
	                              ...
	                              <div class="widget-body col-xs-12">
	                              	<div class="form-group">
                                           ...
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="BPM">心率(分钟/下):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input type="number" name="BPM" id="BPM"  value="${pd.BPM }" placeholder="输入心率"  title="心率" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
                                  	<div class="form-group">
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="SPRESSURE">收缩压(mmol/L):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input  type="number" step="0.01" name="SPRESSURE" id="SPRESSURE" value="${pd.SPRESSURE }" placeholder="请输入收缩压" title="收缩压" style="width:98%;"/>
                                                   </span>
                                               </div>
                                           </div>
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="DIASTOLE">舒张压(mmol/L):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input type="number" step="0.01" name="DIASTOLE" id="DIASTOLE"  value="${pd.DIASTOLE }" placeholder="请输入舒张压"  title="舒张压" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
...
<script type="text/javascript">
	...
	function save(){
		...
		if($("#SPRESSURE").val()==""){
			...
			$("#SPRESSURE").val($.trim($("#SPRESSURE").val()));
		}
		...
		if($("#DIASTOLE").val()==""){
			...
			$("#DIASTOLE").val($.trim($("#DIASTOLE").val()));
		}
