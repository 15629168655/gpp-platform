			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<!-- 检索  -->
						<form action="zyyzjl/list.do?id=${pd.id }" method="post" name="userForm" id="userForm">
								...
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList }" var="varList" varStatus="vs">
										<tr>
                                            ...
                                            <td class="center">${varList.XDRXM }</td>
											<td class="center">
												...
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a style="cursor:pointer;" onclick="CKXQ('${varList.ID}','${pd.USER_AGENT_ID }');" class="tooltip-success" data-rel="tooltip" title="查看详情">
																	<span class="green">
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
 	...
 	<script type="text/javascript">
		...
		function CKXQ(ID, user_id){
			 ...
			 diag.Drag=true;
			 diag.Title ="住院医嘱记录详情";
			 diag.URL = '<%=basePath%>zyyzjl/goCKXQ.do?ID='+ID+'&USER_AGENT_ID='+user_id;
			 diag.Width = 1050;
			 diag.Height = 700;
