package com.tbyf.controller.system.appuser;
...
import com.tbyf.util.GetPinyin;
...
public class AppuserController extends BaseController {
	...
	public ModelAndView saveU() throws Exception{
		...
		pd.put("NAMEPY", GetPinyin.getPingYin(pd.get("NAME").toString()));
		pd.put("RIGHTS", "");					
		...
		try{
			if(Jurisdiction.buttonJurisdiction(menuUrl, "cha")){	
				...
				for(int i=0;i<userList.size();i++){
					...
					vpd.put("var2", userList.get(i).getString("NUM"));		//2
