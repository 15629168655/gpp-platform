			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="agreementApply/getJMXX.do" method="post" name="userForm" id="userForm">
						...
						<table id="simple-table" class="table table-striped table-bordered table-hover" style="margin-top:5px;">
							...
							<c:choose>
								<c:when test="${not empty jmxxList}">
									...
									<tr GH="${jmxxList.USER_AGENT_ID}" MC="${jmxxList.USER_NAME}" DH="${jmxxList.TELEPHONE}" MI="${jmxxList.MI_CARD}" CARD="${jmxxList.ID_NUMBER}" XB="${jmxxList.SEX}" >
