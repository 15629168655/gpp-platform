						...
						<table style="width:100%;">
							<tr>
								<!-- <td style="vertical-align:top;">
                                    <a class="btn btn-sm btn-success" onclick="chooseData();">确定选择</a>
								</td> -->
	...
	<script type="text/javascript">
		...
		function chooseData(msg){
					...
					for(var i=0;i < document.getElementsByName('ids').length;i++){
					 ...
					 iframe.contents().find("#diseases_code").val(pid);
					 iframe.contents().find("#diseases_name").val(pname);
				     top.Dialog.close();
		}
		...
		$(function () {
	     ...
	     // 选择行变色 
	        $("#simple-table > tbody > tr").click(function (){ 
	            ...
	            $("#_id").val($(trThis).attr("GH"));
	            $("#_name").val($(trThis).attr("MC"));
	        });
	    }) 
	</script>
