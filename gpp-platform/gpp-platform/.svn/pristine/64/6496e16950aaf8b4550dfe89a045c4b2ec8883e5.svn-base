			...
			<div class="page-content">
				...
				<div class="row">
					...
					<form action="diseasecode/${msg }.do" name="Form" id="Form" method="post" class="form-horizontal">
						...
						<div class="form-group">
							<div class="col-xs-12 col-sm-4">
                                <label class="col-sm-4 control-label no-padding-right" for="DISEASE_ADVICE">疾病描述和建议:</label>
                                <div class="col-sm-8">
                                    <input type="text" class="col-sm-12" name="DISEASE_ADVICE" id="DISEASE_ADVICE" value="${pd.DISEASE_ADVICE}" maxlength="64" placeholder="拼音助记码" title="拼音助记码" style="width:100%;">
                                </div>
							</div>
						</div>
						<div class="form-group">
