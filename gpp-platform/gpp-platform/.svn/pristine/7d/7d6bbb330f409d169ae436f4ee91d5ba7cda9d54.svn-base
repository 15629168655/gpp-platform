		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="treateCaseRecord/updateCase.do" name="Form" id="Form" method="post">
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								<tr> 
									...
									<td>
										<input   readonly="readonly" type="text" name="MODEL_NAME" id="MODEL_NAME" value="${pd.MODEL_NAME }" placeholder="点击选择方案模板" maxlength="40" title="这里输入名称" style="width:100%;"/>
								...
								<tr>
									...
									<td>
										<input readonly="readonly" type="text" name="RESIDENT_NAME" id="RESIDENT_NAME" value="${pd.RESIDENT_NAME }" placeholder="点击选择居民" maxlength="40" title="这里输入名称" style="width:100%;" />
									</td>
								</tr>
								<tr>
									<td style="width:180px;text-align: right;padding-top: 13px;">适用人群<span class="red">*</span>:</td>
									<td>
										<select class="form-control"  name="PEOPLE_TYPE" id="PEOPLE_TYPE" style="width:100%" disabled="disabled">
								...
								<tr>
									...
									<td>
										<select class="form-control"  name="DISEASE_NAME" id="DISEASE_NAME" style="width:100%" disabled="disabled">
								...
								<tr>
									...
									<td>
										<input readonly="readonly" type="number"  name="TREATE_COUNT" id="TREATE_COUNT"  value="${pd.TREATE_COUNT }" placeholder="治疗次数"  title="医生"  style="width:100%;"/>
									</td>
								</tr>
								<tr>
										...
										<table>
											<tr>
												<td style="width: 500px">
													<input readonly="readonly" name="INTERVAL_TIME" id="INTERVAL_TIME"  value="${pd.INTERVAL_TIME }" type="number"  style="width:100%;" placeholder="方案时间" title="方案时间"/>
												</td>
												<td style="width: 100px">
													<select class="form-control"  name="INTERVAL_COMPANY" id="INTERVAL_COMPANY" style="width:100%" disabled="disabled">
								...
								<tr>
									...
									<td style="padding-top: 3px;" id="CONTENT" >
										<input class="span10 date-picker" name="START_TIME" id="START_TIME"  value='<fmt:formatDate pattern="yyyy-MM-dd" value="${pd.START_TIME}" />' type="text" data-date-format="yyyy-mm-dd" readonly="readonly" style="width:100%;" placeholder="方案时间" title="方案时间"/> 
									</td>
								</tr>
								<tr>
									<td style="width:180px;text-align: right;padding-top: 13px;">提醒时间:</td>
									<td style="padding-top: 3px;" id="CONTENT" >
										<input readonly="readonly"  name="REMIND_TIME" id="REMIND_TIME"  value='${pd.REMIND_TIME }' type="text"  style="width:100%;" placeholder="提醒时间(不填默认为3天)单位：天" title="提醒时间"/> 
									</td>
								</tr>
								<tr>
									<td style="width:180px;text-align: right;padding-top: 13px;">执行的效果:</td>
									<td style="padding-top: 3px;" id="CONTENT" >
										<select class="form-control"  name="IMPL_EFFECT" id="IMPL_EFFECT" style="width:100%" >
									         <option value="" selected="selected">---执行的效果---</option>
									         <c:forEach items="${IMPLEFFECF}" var="tw">
                                                  <option value="${tw.key}" <c:if test="${tw.key == pd.IMPL_EFFECT}"> selected="selected" </c:if> >${tw.value}</option>
                                             </c:forEach>
									    </select>
									</td>
								</tr>
								<tr>
									<td style="width:180px;text-align: right;padding-top: 13px;">执行建议:</td>
									<td style="padding-top: 3px;" id="CONTENT" >
										 <script id="suggestion" name=IMPL_SUGGESTION type="text/plain" style="width:600px;height:159px;">${pd.IMPL_SUGGESTION }</script>
									</td>
								</tr>
								<tr>
