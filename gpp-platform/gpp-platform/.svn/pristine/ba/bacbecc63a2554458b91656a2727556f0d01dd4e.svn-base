				...
				<div class="page-content">
					<div class="row">
						...
						<form action="happuser/${msg }.do" name="userForm" id="userForm" method="post">
							...
							<input type="hidden" name="editMode" id="editMode" value="${pd.editMode }"/>
							...
							<table id="table_report" class="table table-striped table-bordered table-hover">
								...
								<tr>
									...
									<td><input type="text" name="NUM" id="NUM" value="${pd.NUM}" maxlength="32" placeholder="这里输入编号" title="编号" onblur="hasN('${pd.USERNAME }')" style="width:98%;" /></td>
