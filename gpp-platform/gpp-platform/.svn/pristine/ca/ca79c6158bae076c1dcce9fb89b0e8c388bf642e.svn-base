		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="sugar/${msg }.do" name="Form" id="Form" method="post" class="form-horizontal" autocomplete="off">
			                     ...
			                     <div class="widget-header">
	                              ...
	                              <div class="widget-body col-xs-12">
	                              	<div class="form-group">
                                           ...
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="SUGAR_VALUE">血糖值(mmol/L):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input type="number" step="0.0001" name="SUGAR_VALUE" id="SUGAR_VALUE"  value="${pd.SUGAR_VALUE }" placeholder="请输入血糖值"  title="血糖值"  style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
                                  	<div class="form-group">
							  		 ...
							  		 <div class="form-group">
                                                <div class="col-xs-12 col-sm-6">
                                                    <label class="col-sm-4 control-label no-padding-right" for="TIME_CLASS">测试时段:</label>
                                                    <div class="col-sm-8" id="COMMUNITYDiv">
                                                        <span   class="col-sm-12 from-control-span">
                                                        <select class="form-control"  name="TIME_CLASS" id="TIME_CLASS" style="width:98%">
													         <option value="" selected="selected">请选择测试时段</option>
													         <c:forEach items="${pd.TIMEENUM}" var="tw">
				                                                  <option value="${tw.key}" <c:if test="${tw.key == pd.TIME_CLASS}"> selected="selected" </c:if> >${tw.value}</option>
				                                             </c:forEach>
													    </select>
                                                        </span>
                                                    </div>
...
<script type="text/javascript">
	...
	function save(){
		if($("#TIME_CLASS").val()==""){
			...
			$("#TIME_CLASS").val($.trim($("#TIME_CLASS").val()));
		}
		...
		if($("#SUGAR_VALUE").val()==""){
			...
			$("#SUGAR_VALUE").val($.trim($("#SUGAR_VALUE").val()));
		}
