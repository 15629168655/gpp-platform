		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<!-- 检索  -->
						<form action="treateCase/list.do" method="post" name="userForm" id="userForm">
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
 	...
 	<script type="text/javascript">
		...
		function showCase(RESIDENT_ID) {
			$.ajax({
				type:"post",
				url : '<%=basePath%>treateCase/dataCase?RESIDENT_ID='+RESIDENT_ID,
		...
		function showInfo(CASE_ID) {
			top.jzts();
			 ...
			 diag.Drag=true;
			 diag.Title ="方案内容";
			 diag.URL = '<%=basePath%>treateCase/caseInfo.do?CASE_ID='+CASE_ID;
			 diag.Width = 800;
			 diag.Height = 1000;
			 diag.CancelEvent = function(){ //关闭事件
				 if(diag.innerFrame.contentWindow.document.getElementById('zhongxin').style.display == 'none'){
