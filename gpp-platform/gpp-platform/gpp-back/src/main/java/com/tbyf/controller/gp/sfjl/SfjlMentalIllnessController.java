...
@Controller
@RequestMapping(value="/sljlmentalillness")
public class SfjlMentalIllnessController extends BaseController {
	String menuUrl = "sljlmentalillness/list.do"; //菜单地址(权限用)
	...
	public ModelAndView list(Page page){
		...
		try{
			...
			page.setPd(pd);
			List<PageData>	list = sfjlMentalillnessService.list(page);  //列表
			mv.setViewName("gp/sfjl/sfjlmentalillness/sfjlmentalillness_list");
	...
	public ModelAndView goEdit(){
		...
		pd = this.getPageData();
		try {
			pd = sfjlMentalillnessService.findById(pd);					 //根据ID读取
			...
			mv.setViewName("gp/sfjl/sfjlmentalillness/sfjlmentalillness_edit");
	...
	public ModelAndView edit() throws Exception{
		...
		sfjlMentalillnessService.edit(pd);
...
//		pd.put("state", eaN);								//状态(正常状态)
	...
	public void delete(PrintWriter out) throws Exception{
		...
		sfjlMentalillnessService.delete(pd);
		out.write("success");
		out.close();
	}
