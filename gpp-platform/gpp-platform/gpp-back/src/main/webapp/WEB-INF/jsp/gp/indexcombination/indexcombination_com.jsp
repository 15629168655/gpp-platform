 	...
 	<div id = "zhongxin">
            <div class="tabable">
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li id="indexInfoTab">
                        <a href="#indexInfo" data-toggle="tab" style="cursor:pointer;">
                          指标组合详情
                        </a>
                    </li>
                    
                    <li id="indexMaintainTab">
                        <a href="#indexMaintain"  data-toggle="tab" style="cursor:pointer;">
                          指标列表               
                        </a>
                    </li>
                </ul>
                ...
                <div class="tab-content">
                    <div id="indexInfo" class="tab-pane">
                   		<iframe name="indexInfoFrame" id="indexInfoFrame"  src="<%=basePath%>indexCombination/${msg}.do?ID=${pd.ID}"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="100%" height="500"></iframe>
                    </div> 
                    <div id="indexMaintain" class="tab-pane">
                       <iframe name="indexMaintainFrame" id="indexMaintainFrame"  src="<%=basePath%>indexCombinationRelation/list.do?INDEX_COMBINATION_ID=${pd.ID}"  frameborder="0" scrolling="no" marginheight="0" marginwidth="0" width="100%" height="500"></iframe>
                    </div>
                </div>
            </div>
     </div>
