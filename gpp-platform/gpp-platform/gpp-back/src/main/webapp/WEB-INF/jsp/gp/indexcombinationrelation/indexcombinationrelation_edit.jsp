						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
                                     <a class="btn btn-sm btn-success" onclick="makeAll('批量新增');" title="批量新增">添加指标</a>
								</td>
								<td style="vertical-align:top;">
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '批量新增'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>indexCombinationRelation/save.do?COMBINATION_ID=${pd.COMBINATION_ID}&tm='+new Date().getTime(),
						    	data: {IDS:str},
								dataType:'json',
