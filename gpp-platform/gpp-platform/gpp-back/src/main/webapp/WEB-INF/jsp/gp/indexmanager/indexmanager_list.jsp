		...
		<div class="main-content-inner">
			<div class="page-content">
				<div class="row">
					<div class="col-xs-12">
						<!-- 检索 -->
						<form action="indexmanager/list.do" method="post" name="fatForm" id="fatForm">
...
<script type="text/javascript" src="static/js/jquery.tips.js"></script>
	...
	<script type="text/javascript">
		...
		function add(){
            top.jzts();
            top.siMenu('z71','lm70','新增指标','indexmanager/addIndex.do');
		}
		
		//编辑
        function edit(id){
            top.jzts();
            top.siMenu('z71','lm70','编辑指标','indexmanager/updateInformation.do?ID='+id);
        }
		...
		//删除
		function del(id,msg){
			bootbox.confirm("确定要删除此筛选指标吗?", function(result) {
				if(result) {
					top.jzts();
					var url = "<%=basePath%>indexmanager/delete.do?ID="+id+"&tm="+new Date().getTime();
				...
				if(result) {
					...
					if(str==''){
						...
						if(msg == '确定要删除选中的数据吗?'){
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>indexmanager/deleteAll.do?tm='+new Date().getTime(),
						    	data: {IDS:str},
								dataType:'json',
