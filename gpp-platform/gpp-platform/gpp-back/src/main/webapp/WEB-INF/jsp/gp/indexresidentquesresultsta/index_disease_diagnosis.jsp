...
<body class="no-skin">
										...
										<tr>
											...
											<td class="center">
												...
												<div class="hidden-sm hidden-xs btn-group">
													...
													<a class="btn btn-xs btn-success" title="筛查报告" onclick="report('${jmxxList.USER_AGENT_ID }');">
														筛查报告
													</a>
													<a class="btn btn-xs btn-success" title="健康档案" onclick="health('${jmxxList.ID_NUMBER }');">
														健康档案
													</a>
												</div>
												<div class="hidden-md hidden-lg">
													<div class="inline pos-rel">
														...
														<ul class="dropdown-menu dropdown-only-icon dropdown-yellow dropdown-menu-right dropdown-caret dropdown-close">
															<li>
																<a class="btn btn-xs btn-success" style="cursor:pointer;" onclick="dis('${jmxxList.USER_AGENT_ID }');" class="tooltip-success" data-rel="tooltip" title="诊断">
																	诊断
																</a>
															</li>
															<li>
																<a class="btn btn-xs btn-success" style="cursor:pointer;" onclick="report('${jmxxList.USER_AGENT_ID }');" class="tooltip-error" data-rel="tooltip" title="筛查报告">
																	筛查报告
																</a>
															</li>
															<li>
	...
	<script type="text/javascript" src="static/js/jquery.tips.js"></script>
 	...
 	<script type="text/javascript">
		...
		//健康档案
		function health(CARDID){
			 top.jzts();
			 var diag = new top.Dialog();
			 diag.Drag=true;
			 diag.Title ="健康档案";
			 diag.URL = '<%=basePath%>indexResidentQuesResult/health.do?CARDID='+CARDID;
			 diag.Width = 900;
			 diag.Height = 1000;
			 diag.CancelEvent = function(){ //关闭事件
