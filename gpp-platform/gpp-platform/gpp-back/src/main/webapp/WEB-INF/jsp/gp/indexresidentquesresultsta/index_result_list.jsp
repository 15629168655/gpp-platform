			...
			<div class="main-content-inner">
				<div class="page-content">
					...
					<table id="simple-table" class="table table-bordered " style="margin-top:5px;width:100%" >	
							<thead>
								<tr>
									<th class="center" rowspan="2" >年龄段</th>
									<th class="center" colspan="3">人数</th>
								</tr>
								<tr>
									<th class="center">男性</th>
									<th class="center">女性</th>
...
<script src="static/ace/js/ace/ace.widget-box.js"></script>
	<script type="text/javascript">
		...
		function initData() {
			var url='<%=basePath%>quesResultStatistic/getChartData.do';
		...
		if(type=='0'){
			...
			$.post(url,param,function(data){
				if(data.msg =='00'){
					...
					//	var i =0; 
						item = "<tr><td width='320px' align='center'>"+data.xAxis[i]+"</td><td width='320px' align='center'>"+data.sz[i]+"</td><td width='320px' align='center' >"+data.xz[i]+"</td><td width='320px' align='center'>"+data.num[i]+"</td></tr>"; 
						//i++;
						$('.table').append(item); 
					}
					item = "<tr><td colspan='4' align='center'> 人数总计:"+ data.amount +"人,其中男性:"+data.Mamount+"人,女性"+data.Wamount+"</td>";
					//); 
					$('.table').append(item);
					show();
				}
