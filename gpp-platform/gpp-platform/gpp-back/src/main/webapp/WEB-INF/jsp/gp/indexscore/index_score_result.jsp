					...
					<div class="row">
						...
						<form action="indexScore/save.do" name="Form" id="Form" method="post" class="form-horizontal" autocomplete="off">
	                              ...
	                              <div class="widget-body col-xs-12">
	                              	<div class="form-group">
                                           ...
                                           <div class="col-xs-12 col-sm-6">
                                               ...
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<select  disabled="disabled" class="chosen-select form-control" name="SCORE_RANK" id="SCORE_RANK" data-placeholder="评分等级" style="vertical-align:top;width: 98%;" onchange="scoreRank()">
                            ...
                            <div class="form-group">
								<div class="widget-box col-xs-12">
									 <div class="widget-header">
										   <h5 class="widget-title">您的评分结果</h5>
											   <span class="widget-toolbar">
													<a href="#" data-action="collapse">
														<i class="ace-icon fa fa-chevron-up"></i>
													</a>
									  ...
									  <div class="widget-body col-xs-12">
										<div class="form-group">
											 <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="MOUNT_SCORE">您的分值:</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input readonly="readonly" type="text" name="MOUNT_SCORE" id="MOUNT_SCORE" value="${pdResidentQues.SCORE }" placeholder="评价总分" title="健康账号" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="HEADTHCARDNO">您所属人群:</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input readonly="readonly" type="text" name="MOUNT_SCORE" id="MOUNT_SCORE" value="${pdResidentQues.RANK }" placeholder="评价总分" title="健康账号" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div> 
										</div>
