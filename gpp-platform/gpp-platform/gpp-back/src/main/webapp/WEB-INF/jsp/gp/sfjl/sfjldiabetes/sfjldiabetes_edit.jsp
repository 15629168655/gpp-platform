		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
								<form action="sfjldiabetes/${msg }.do" name="Form" id="Form" method="post">
						...
						<!-- 	<input type="hidden" name="ORG_CODE" id="ORG_CODE" value="${pd.ORG_CODE}"/> -->
									...
									<table id="table_report" class="table table-striped table-bordered table-hover">
										<tr>
											...
											<td><input type="text" name="FSYS" id="FSYS" value="${pd.HDSB040501_006}" readonly="readonly" placeholder="访视医生" title="访视医生" style="width:83%;"/>
										    <a class="btn btn-mini btn-purple" onclick="chooseFSYS();">医生菜单</a></td>
										    <input type="hidden" name="HDSB040501_005" id="HDSB040501_005" value="${pd.HDSB040501_005}" />
										</tr>
										...
										<tr>
											...
											<c:if test="${msg == 'save'}">
												<td><input class="span10 date-picker" name="HDSB040501_003" id="HDSB040501_003" value="<%=nowtime%>" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="访视时间"  title="访视时间" style="width:98%;" /></td>
											</c:if>
											<c:if test="${msg == 'edit'}">
												<td><input class="span10 date-picker" name="HDSB040501_003" id="HDSB040501_003" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${pd.HDSB040501_003}" />" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="访视时间"  title="访视时间" style="width:98%;" /></td>
											</c:if>
										</tr>
										<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">下一次访视时间:</td>
											<td><input class="span10 date-picker" name="HDSB040501_004" id="XYCFSSJ" value="<fmt:formatDate pattern="yyyy-MM-dd" value="${pd.HDSB040501_004}" />" type="text" data-date-format="yyyy-mm-dd" readonly="readonly" placeholder="下一次访视时间"  title="下一次访视时间" style="width:98%;" /></td>
										</tr>
										<tr>
											<td style="width:79px;text-align: right;padding-top: 13px;">随访方式:</td>
											<td>
												<select name="HDSB04050101_003" id="HDSB04050101_003" style="width:98%;">
											         <option value="" selected >请选择</option>
										             <c:forEach items="${pd.EnumSfjlSFFS}" var="item">
				                                        <option value="${item.key}" <c:if test="${pd.HDSB04050101_003 == item.key}"> selected="selected" </c:if> >${item.value}</option>
				                                    </c:forEach>
											     </select>
											 </td>
										</tr>
										<tr>
											...
											<td><input type="text" name="HDSB04050101_006" id="HDSB04050101_006" value="${pd.HDSB04050101_006}" maxlength="20" placeholder="这里输入收缩压" title="收缩压" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">舒张压:</td>
											<td><input type="text" name="HDSB04050101_007" id="HDSB04050101_007" value="${pd.HDSB04050101_007}" maxlength="20" placeholder="这里输入舒张压" title="舒张压" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">身高:</td>
											<td><input type="text" name="HDSB04050101_010" id="HDSB04050101_010" value="${pd.HDSB04050101_010}" maxlength="20" placeholder="这里输入身高" title="身高" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">体重(KG):</td>
											<td><input type="text" name="HDSB04050101_008" id="HDSB04050101_008" value="${pd.HDSB04050101_008}" maxlength="20" placeholder="这里输入体重(单位：KG)" title="体重" style="width:98%;"/></td>
										</tr>
										<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">空腹血糖值（mmol/L):</td>
											<td><input type="text" name=HDSB04050101_032 id="HDSB04050101_032" value="${pd.HDSB04050101_032}" maxlength="20" placeholder="空腹血糖值" title="空腹血糖值" style="width:98%;"/></td>
										</tr>
											<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">餐后两小时血糖值（mmol/L):</td>
											<td><input type="text" name="HDSB04050101_033" id="HDSB04050101_033" value="${pd.HDSB04050101_033}" maxlength="20" placeholder="餐后两小时血糖值" title="餐后两小时血糖值" style="width:98%;"/></td>
										</tr>
											<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">糖化血红蛋白值（％):</td>
											<td><input type="text" name="HDSB04050101_034" id="HDSB04050101_034" value="${pd.HDSB04050101_034}" maxlength="20" placeholder="糖化血红蛋白值（％)" title="糖化血红蛋白值（％)" style="width:98%;"/></td>
										</tr>
											<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">胰岛素用药使用频率（次/d):</td>
											<td><input type="text" name="HDSB04050101_046" id="HDSB04050101_046" value="${pd.HDSB04050101_046}" maxlength="20" placeholder="胰岛素用药使用频率（次/d)" title="胰岛素用药使用频率（次/d)" style="width:98%;"/></td>
										</tr>
											<tr>
											<td style="width:120px;text-align: right;padding-top: 13px;">胰岛素用药次剂量（u):</td>
											<td><input type="text" name="HDSB04050101_047" id="HDSB04050101_047" value="${pd.HDSB04050101_047}" maxlength="20" placeholder="胰岛素用药次剂量（u)" title="胰岛素用药次剂量（u)" style="width:98%;"/></td>
										</tr>
