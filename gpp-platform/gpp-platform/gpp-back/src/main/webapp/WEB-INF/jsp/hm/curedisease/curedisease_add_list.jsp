			...
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						...
						<!-- 检索  -->
						<form action="curedisease/goAddDis.do" method="post" name="Form" id="Form">
							...
							<c:choose>
								<c:when test="${not empty varList}">
									...
									<c:forEach items="${varList}" var="var" varStatus="vs">
										<tr>
											<td class='center'>
												<label class="pos-rel"><input type='checkbox' name='ids' value="${var.JBBM}" class="ace" /><span class="lbl"></span></label>
											</td>
						...
						<table style="width:100%;">
							<tr>
								<td style="vertical-align:top;">
									<c:if test="${QX.add == 1 }">
										<a class="btn btn-sm btn-success" onclick="save('确定要新增选中的数据吗?');">保存</a>
									</c:if>
									<c:if test="${QX.del == 1 }">
...
//							var nodes = treeObj.getSelectedNodes();
							...
							$.ajax({
								type: "POST",
								url: '<%=basePath%>curedisease/saveAll.do?ORG_CODE='+ORG_CODE,
								data: {DATA_IDS:str},
								dataType:'json',
