		...
		<div class="main-content">
			<div class="main-content-inner">
				<div class="page-content">
					<div class="row">
						<div class="col-xs-12">
						<form action="fat/${msg }.do" name="Form" id="Form" method="post" class="form-horizontal" autocomplete="off">
							<input type="hidden" name="ID" id="ID" value="${pd.ID }"/>
							<div id="zhongxin" style="padding-top: 13px;">
							<div class="form-group">
                            <div class="widget-box col-xs-12">
			                     <div class="widget-header">
			                           <h5 class="widget-title">血脂四项记录</h5>
	                              ...
	                              <div class="widget-body col-xs-12">
	                              	<div class="form-group">
                                           ...
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="CHO">总胆固醇(mmol/L):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input type="number" step="0.0001" name="CHO" id="CHO"  value="${pd.CHO }" placeholder="请输入总胆固醇"  title="总胆固醇" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
                                  	...
                                  	<div class="form-group">
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="LOW_FAT">低密度脂蛋白(mmol/L):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input  type="number" step="0.0001" name="LOW_FAT" id="LOW_FAT" value="${pd.LOW_FAT }" placeholder="请输入低密度脂蛋白" title="低密度脂蛋白" style="width:98%;"/>
                                                   </span>
                                               </div>
                                           </div>
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="HIG_FAT">高密度脂蛋白(mmol/L):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input type="number" step="0.0001" name="HIG_FAT" id="HIG_FAT"  value="${pd.HIG_FAT }" placeholder="请输入高密度脂蛋白"  title="高密度脂蛋白" style="width:98%;" />
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
                                  	...
                                  	<div class="form-group">
							  		 ...
							  		 <div class="form-group">
                                           <div class="col-xs-12 col-sm-6">
                                               <label class="col-sm-4 control-label no-padding-right" for="GLY">甘油三酯(mmol/L):</label>
                                               <div class="col-sm-8">
                                                   <span  class="col-sm-12 from-control-span">
                                                   		<input  type="number" step="0.0001" name="GLY" id="GLY" value="${pd.GLY }" placeholder="请输入甘油三酯" title="甘油三酯" style="width:98%;"/>
                                                   </span>
                                               </div>
                                           </div>
                                  	</div>
