	...
	<table style="width: 100%;" border="0">
		<tr>
			...
			<td style="width: 85%" valign="top">
				 <iframe name="treeFrame" id="treeFrame" frameborder="0" src="<%=basePath%>/yhry/yhrylist.do"  style="margin:0 auto;width:100%;height:100%;"></iframe> 
			</td>
		</tr>
	</table>
	...
	<script type="text/javascript">
		...
		$(document).ready(function(){
			...
			var setting = {
					...
					,async: {
						enable: true,
						url:"<%=basePath%>/organization/treeData.do?type=yhry&action=yhrylist",
						autoParam: ["id", "name"]
					},callback:{
