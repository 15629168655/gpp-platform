		...
		<table style="width:98%;margin-top: 10px;margin-left: 9px;" >
			<tr>
				<td style="margin-top:0px;">
					 <div style="float: left;" style="width:81%"><textarea readonly="readonly" name="USERNAME" id="USERNAME" rows="1" cols="50" style="width:505px;height:32px;" title="这里不能手动修改">${pd.username}</textarea>
					 	<input type="hidden" name="CUNZHI" id="CUNZHI" value="" style="width:98%;" /><!-- 这个隐藏框仅仅是存值用 -->
					 </div>
					 <a class="btn btn-mini btn-purple" onclick="chooseUser();">选取发送用户</a>
...
<script type="text/javascript">
	...
	function chooseUser(){
		 ...
		 diag.Drag = true;
		 diag.Title = "用户信息";
		 diag.URL = '<%=basePath%>	fhsms/listUsers.do';
		 diag.Width = 1000;
		 diag.Height = 800;
