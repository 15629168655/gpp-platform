package com.tbyf.service.system.dictionaries.impl;
...
public class DictionariesService implements DictionariesManager{
     ...
     * @throws Exception
     */
	public Map queryDictionary(String bianma) throws  Exception{
        return (Map) dao.findForMap("DictionariesMapper.queryDictionary",bianma,"BIANMA");
    }
}
