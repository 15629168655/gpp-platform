...
public class Const {
	...
	public static final String appKey = "3a5139c1d4dfb5e349610aa6";//极光推送
	public static final String masterSecret = "92bd805ce57968d257f96a1a";//极光推送
	public static final int	   maxRetryTime = 3 ;//极光推送
	
	public static final int    REMIND_TIME = 3 ;//默认的提醒的时间
	...
	//app用户根据手机号+验证码登陆
	public static final String[] APP_LOGINBYPHONECODE_PARAM_ARRAY = new String[]{"PHONE","YZM","TYPE"};
	public static final String[] APP_LOGINBYPHONECODE_VALUE_ARRAY = new String[]{"手机号","验证码","用户类型"};
	...
	//app签约团队名称唯一性判断
	public static final String[] APP_ADDGPP_TEAM_VALIDATE_PARAM_ARRAY = {"ID","TEAM_NAME"};
	public static final String[] APP_ADDGPP_TEAM_VALIDATE_VALUE_ARRAY = {"团队ID","团队名称"};
		
	//app签约团队成员唯一性判断
	public static final String[] APP_ADDGPP_TEAMMEMBER_VALIDATE_PARAM_ARRAY = {"ID","TEAM_MEMBER_ID"};
	public static final String[] APP_ADDGPP_TEAMMEMBER_VALIDATE_VALUE_ARRAY = {"主键","成员ID"};
	...
	//app全科医生新增任务中的参数
		...
		//根据医生查询团队
		public static final String[] APP_TEAMQUERYPAGEBYPROVIDER_AGREEMENT_PARAM_ARRAY = {"PROVIDER_ID","ORG_CODE","FKEY"};
		public static final String[] APP_TEAMQUERYPAGEBYPROVIDER_AGREEMENT_VALUE_ARRAY = {"医生ID","机构编码","参数验证"};
		...
		//医生用户绑定手机号
		public static final String[] APP_USER_PHONEBIND_PARAM_ARRAY = {"PROVIDER_ID","TELEPHONE","YZM"};
		public static final String[] APP_USER_PHONEBIND_VALUE_ARRAY= {"医生ID","手机号","验证码"};		
		...
		//app随访模版查询
		public static final String[] APP_SFTEMP_AGREEMENT_PARAM_ARRAY = {"PROVIDER_ID"};
		public static final String[] APP_SFTEMP_AGREEMENT_VALUE_ARRAY = {"医生id"};
		
		//app随访模版新增
		public static final String[] APP_SFTEMP_SAVE_PARAM_ARRAY = {"NAME","PROVIDER_ID","PROVIDER_NAME","SFLX","CREATE_TIME"};
		public static final String[] APP_SFTEMP_SAVE_VALUE_ARRAY = {"模板名称","医生id","医生名称","随访类型","创建时间"};
		
		//app随访模版修改
		public static final String[] APP_SFTEMP_EDIT_PARAM_ARRAY = {"GUID","NAME","SFLX"};
		public static final String[] APP_SFTEMP_EDIT_VALUE_ARRAY = {"模板ID","模板名称","随访类型"};
		
		//app随访心电图记录新增
		public static final String[] APP_XDT_ADD_PARAM_ARRAY = {"ID","JSON"};
		public static final String[] APP_XDT_ADD_VALUE_ARRAY = {"随访记录ID","JSON数据"};
		...
		//app根据医生机构查询医护人员
		public static final String[] APP_GETPROVIDERBYUSERANDCODE_PARAM_ARRAY = {"PROVIDER_ID","ORG_CODE"};
		public static final String[] APP_GETPROVIDERBYUSERANDCODE_VALUE_ARRAY = {"医生ID","机构编码"};
		...
		//app健康管理初始化
		public static final String[] APP_JKGL_INIT_PARAM_ARRY = {"USER_AGENT_ID","HEIGHT","WEIGHT","BIRTHDAY_TIME"};
		public static final String[] APP_JKGL_INIT_VALUE_ARRY = {"居民ID","身高","体重","出生日期"};
		...
		//app保存设备信息
		public static final String[] APP_DEVICEPUSH_SAVEDEVICE_PARAM_ARRY={"DEVUSERID","DEVICETYPE"};
		public static final String[] APP_DEVICEPUSH_SAVEDEVICE_VALUE_ARRY={"推送ID","设备类型"};
		//更新用户信息
		public static final String[] APP_DEVICEPUSH_SAVEUSER_PARAM_ARRY={"DEVUSERID","USERID","TYPE","DEVICETYPE"};
		public static final String[] APP_DEVICEPUSH_SAVEUSER_VALUE_ARRY={"设备ID","用户Id","用户类型","设备类型"};
		//更新站内信等信息
		public static final String[] APP_DEVICEPUSH_SAVEFOURMSGTYPE_PARAM_ARRY = {"DEVUSERID","ISBROAD","ISPMSG","ISZXMSG","ISWORKMSG","DEVICETYPE","USERID","TYPE"};
		public static final String[] APP_DEVICEPUSH_SAVEFOURMSGTYPE_VALUE_ARRY = {"设备ID","是否开启广播","是否开启站内信","是否开启咨询消息提醒","是否开启工作任务提醒","设备类型","用户Id","用户类型"};
